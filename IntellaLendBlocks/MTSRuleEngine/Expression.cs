    ...
    public class Expression
    {
        ...
        public MTSResult Evaluate()
        {
            ...
            if (Options.IterateParameters())
            {
                ...
                return new MTSResult() { Result = results, Message = visitor.Message };
            }

            ParsedExpression.Accept(visitor);
            return new MTSResult() { Result = visitor.Result, Message = visitor.Message };
        }

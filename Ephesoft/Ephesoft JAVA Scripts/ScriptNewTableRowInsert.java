...
public class ScriptNewTableRowInsert implements IJDomScript {

	private static EphesoftLogger LOGGER = ScriptLoggerFactory.getLogger(ScriptNewTableRowInsert.class);
	...
	public Object execute(Document document, String methodName, String docIdentifier) {
		...
		try {
			LOGGER.info("*************  Inside ScriptNewTableRowInsert scripts.");

			LOGGER.info("*************  Start execution of the ScriptNewTableRowInsert scripts.");
			...
			// writeToXML(document);
			LOGGER.info("*************  End execution of the ScriptNewTableRowInsert scripts.");
		} catch (Exception e) {
